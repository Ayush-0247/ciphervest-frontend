...
function FloatField({
  ...
  return (
    <div
      className={`${styles.field} ${focused ? styles.fieldFocused : ""} ${value ? styles.fieldFilled : ""}`}
    >
      <input
        type={type}
        name={id}
      ...
      <div className={styles.page}>
        ...
        <div className={styles.successWrap}>
          ...
          <p className={styles.successMsg}>
            Thank you, <strong>{form.name.split(" ")[0]}</strong>. A dedicated
            specialist will respond to{" "}
            <span className={styles.successEmail}>{form.email}</span> within one
            business day.
          </p>
          <div className={styles.successActions}>
            ...
            <a href="/" className={styles.homeBtn}>
              ...
              >
                ...
                />
                <path
                  d="M3 6.5V13H6.5V9.5H8.5V13H12V6.5"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
  ...
  return (
    ...
    "
          ...
          <p className={styles.subtext}>
            Every query is handled by a dedicated specialist — not a bot. We're
            committed to thoughtful, personalised financial service.
          </p>
        ...
        <main className={styles.formPanel}>
          ...
          >
            ...
            <div className={styles.row}>
              <div
                className={`${styles.field} ${form.queryType ? styles.fieldFilled : ""}`}
              >
                <select
                  name="queryType"
                  id="queryType"
