...
export default function Hero() {
  ...
  return (
    <section className={styles.hero}>
      ...
      {!hideEnvelope && (
        <div
          className={`${styles.mailScene} ${fadeOutScene ? styles.fadeOut : ""}`}
        >
          <div
            className={`${styles.envelope} ${envelopeOpen ? styles.open : ""}`}
          >
      ...
      {/* ── HERO CONTENT ────────────────────────────────── */}
      <div
        className={`${styles.container} ${showContent ? styles.reveal : ""}`}
      >
